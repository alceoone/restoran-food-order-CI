...
<body>
    ...
    <div class="row no-gutters">
        <div class="col-md-2 bg-dark text-white" style="min-height: 100vh;">
            ...
            <ul class="nav flex-column ">
                ...
                <li class="nav-item">
                    <a class="nav-link bg-oren text-white" href="../orderan_kirim.php">
                ...
                <table class="table table-bordered" align="center">
                    ...
                    <tr>
                        ...
                        class="btn btn-primary" data-toggle="tooltip" data-placement="bottom"
                            title="Konfirmasi">Kirim dan Antar Pesanan</button></td>
                    </tr>              
                    </tbody>
                </table>
            </div>
    ...
    <div id="modal-wrapper" class="modal">
        <form class="modal-content animate" action="respone_kirim_orderan.php?id=<?php echo $id ?>&status=<?php echo $status ?>" method="post">
                <span onclick="document.getElementById('modal-wrapper').style.display='none'" class="close" title="Close PopUp">&times;</span>
                <h5 align="center" class="mt-3">Konfirmasi Pesanan</h5>
            <div class="container">
                1. Apa Pesanan Sudah di Cek?<p></p>
                2. Buat Pesanan<p></p>
                3. Apa anda yakin Masuk Ke Antrian Masak Makanan?<p></p>
                <button class="btn btn-primary text-white mt-2">Antar Pesanan</button>
             </div>
        </form>
    </div>
