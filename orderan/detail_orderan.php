...
<body>
    ...
    <div class="row no-gutters">
        <div class="col-md-2 bg-dark text-white" style="min-height: 100vh;">
            ...
            <ul class="nav flex-column ">
                ...
                <li class="nav-item">
                    <a class="nav-link bg-oren text-white" href="../order.php">
                ...
                <table class="table table-bordered" align="center">
                    ...
                    <tr>
                        ...
                        class="btn btn-primary" data-toggle="tooltip" data-placement="bottom"
                            title="Konfirmasi">Konfirmasi</button></td>
                    </tr>              
                    </tbody>
                </table>
            </div>
    ...
    <div id="modal-wrapper" class="modal">
        <form class="modal-content animate" action="respone_kirim.php?id=<?php echo $id ?>&status=<?php echo $status ?>" method="post">
            ...
            <div class="container">
                ...
                <button class="btn btn-primary text-white mt-2">Buat Pesanan</button>
             </div>
        </form>
    </div>
